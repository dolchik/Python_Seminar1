...
i = int(input('Введите номер вагона, в который должен был сесть Витя: '))
j = int(input('Введите номер вагона, в который сел Витя: '))

if i != j:
    result = i + j - 1
    print('Возможное кол-во вагонов: ', result)
else:
    print('Данные не позволяют определить кол-во вагонов')
